...
const SignUpForm = () => {
  ...
  return (
    <form className="mx-auto bg-base-100/50 backdrop-blur w-96 flex flex-col shadow-lg rounded-xl py-6 mt-24 border border-base-300 overflow-hidden ring-2 ring-base-100">
