...
const UserOrderDetailsPage = () => {
	...
	return (
		<>
			...
			>
				<div className="my-5 max-w-7xl w-screen flex flex-col mx-auto bg-base-100 overflow-hidden rounded-3xl shadow [&_.active+div]:max-h-[2000px] [&_.active+div]:pb-6 mb-6">
