...
export function RequestCard(props: RequestDto) {
	return (
		<Link
			...
			className="icn-hvr-fill p-1 rounded-lg shadow hover:shadow-2xl hover:scale-105 transition-all bg-base-100/25 backdrop-blur-lg h-max-content border border-base-200/75 select-none "
		>
