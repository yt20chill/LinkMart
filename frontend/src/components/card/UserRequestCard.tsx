...
export function UserRequestCard({
  ...
  return (
    <div
      ...
      className="flex gap-3 w-full mb-2 bg-base-100/75 backdrop-blur-lg icn-hvr-fill rounded-xl p-2 hover:shadow-xl hover:-translate-y-1 transition-all h-fit border border-slate-500/20 select-none overflow-hidden hover:ring-2 ring-secondary-400"
    >
